  ...
  <div>
    ...
    <Wrapper>
      <div class="max-w-lg mx-auto">
        ...
        <div v-else @dblclick="toggleEditMode" class="hover:cursor-pointer bg-white shadow-lg rounded-lg px-6 pt-4 pb-6 mb-6 transition duration-300 ease-in-out hover:shadow-xl">
          <div class="mb-4">
            <label class="block text-gray-800 font-semibold mb-1">Behavior Status</label>
            <span class="text-gray-600">{{ behaviorStatus }}</span>
          </div>

          <div class="mb-4">
            <label class="block text-gray-800 font-semibold mb-1">First Name:</label>
            <span class="text-gray-600">{{ profile.firstName }}</span>
          </div>

          <div class="mb-4">
            <label class="block text-gray-800 font-semibold mb-1">Last Name:</label>
            <span class="text-gray-600">{{ profile.lastName }}</span>
          </div>

          <div class="mb-4">
            <label class="block text-gray-800 font-semibold mb-1">Date of Birth:</label>
            <span class="text-gray-600">{{ formatDate(profile.dob) }}</span>
          </div>

          <div class="mb-4">
            <label class="block text-gray-800 font-semibold mb-1">Laundry Service</label>
            <span class="text-gray-600">{{ laundryService }}</span>
          </div>

          <div class="mb-4">
            <label class="block text-gray-800 font-semibold mb-1">Reserved Bunk</label>
            <span class="text-gray-600">{{ profile.bunk_reservation_number }}</span>
          </div>

          <div class="mb-4">
            <label class="block text-gray-800 font-semibold mb-1">Locker</label>
            <span class="text-gray-600">{{ profile.locker }}</span>
          </div>

          <div v-if="profile.has_accommodation" class="mb-4">
            <span class="text-green-500 font-bold">Reasonable Accommodation</span>
            <br>
            <span class="text-gray-600">{{ profile.desc_accommodation }}</span>
          </div>

          <div class="mb-4">
            <label class="block text-gray-800 font-semibold mb-1">Consecutive Days Stayed:</label>
            <span class="text-gray-600">{{ profile.consecutiveDaysStayed }}</span>
          </div>

          <div class="mb-4">
            <label class="block text-gray-800 font-semibold mb-1">Latest Check In Date:</label>
            <span class="text-gray-600">{{ formatDate(profile.latestCheckInDate) }}</span>
          </div>

          <div class="mb-4">
            <label class="block text-gray-800 font-semibold mb-1">HMIS Status</label>
            <span class="text-gray-600">{{ hmisStatus }}</span>
          </div>

          <div class="mb-4">
            <label class="block text-gray-800 font-semibold mb-1">HMIS Enter Date</label>
            <span class="text-gray-600">{{ formatDate(profile.hmus_date) }}</span>
          </div>
        </div>
      </div>
    </Wrapper>
